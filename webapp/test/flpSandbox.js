		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#morixezfirecibosaprob-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"morixezfirecibosaprob-display": {
								"semanticObject": "morixezfirecibosaprob",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=morixe.zfirecibosaprob",
									"url": sap.ui.require.toUrl("morixe/zfirecibosaprob")
								}
							}
						}
					}
